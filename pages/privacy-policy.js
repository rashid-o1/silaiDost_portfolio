      ...
      <section className="px-4 py-16 md:py-24">
        <div className="max-w-5xl mx-auto">
          <div className="mb-14 text-center">
            <div className="flex justify-center mb-6">
              <img
                ...
                alt="SilaiDost Logo"
                className="object-contain w-24 h-24 dark:hidden md:w-28 md:h-28"
              />

              <img
                src="/images/silaiDost_white_logo.png"
                alt="SilaiDost Logo"
                className="hidden object-contain w-24 h-24 dark:block md:w-28 md:h-28"
              />
            </div>
          ...
          <div className="space-y-12">
            <div className="p-8 bg-gray-50 border border-gray-200 rounded-3xl dark:bg-neutral-900 dark:border-neutral-800">
            ...
            <div className="p-8 bg-gray-50 border border-gray-200 rounded-3xl dark:bg-neutral-900 dark:border-neutral-800">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {[
                  ...
                  <div
                    key={index}
                    className="p-5 bg-white border border-gray-200 rounded-2xl dark:bg-black dark:border-neutral-800"
                  >
            ...
            <div className="p-8 bg-white border border-gray-200 rounded-3xl shadow-sm dark:bg-neutral-900 dark:border-neutral-800">
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                ...
                <div className="p-6 bg-gray-50 border border-gray-200 rounded-2xl dark:bg-black dark:border-neutral-800">
